...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "bg-teal-400 opacity-75 absolute right-0 bottom-0 top:0 left-0"
    },
    [
      _vm._m(0),
      _vm._v(" "),
      ...
      _c(
        ...
        [
          ...
          _c(
            ...
            {
              staticClass:
                "text-gray-400 hover:text-gray-300 text-sm font-semibold",
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "sm:flex items-center justify-around sm:px-4 sm:py-2 text-sm"
      },
      [
        _c(
          "div",
          {
            staticClass:
              "text-center sm:flex-1 text-gray-700 text-xl text-semibold leading-none"
          },
          [
            _c(
              "p",
              { staticClass: "pt-2 leading-tight font-myriad font-light" },
              [
                _vm._v("\n        Graphics + Design\n        "),
                _c("br"),
                _vm._v(" "),
                _c("span", { staticClass: "text-base line-height-none" }, [
                  _c("span", { staticClass: "italic" }, [
                    _vm._v(" Imaging at the Speed of Business")
                  ]),
                  _c("br"),
                  _vm._v("\n        Hours of Operation: M-F 8:30am-6pm")
                ])
              ]
            )
          ]
        ...
        [
          ...
          _c("div", { staticClass: "md:hidden" }, [
            _c(
              ...
              {
                staticClass:
                  "block text-gray-200 hover:text-white focus:text-white focus:outline-none",
                attrs: { type: "button" },
                on: {
  ...
  function() {
    ...
    return _c("div", [
      _c(
        ...
        {
          staticClass:
            "h-6 sm:h-8 text-gray-100 text-xl text-semibold hover:text-gray-700 tracking-tight font-myriad",
          attrs: { href: "/" }
        },
        [_vm._v("Graphics + Design")]
      )
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('nav-component', __webpack_require__(/*! ./components/NavComponent.vue */ "./resources/js/components/NavComponent.vue")["default"]); // Vue.component('navlanding-component', require('./components/NavLandingComponent.vue').default);

vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('footer-component', __webpack_require__(/*! ./components/FooterComponent.vue */ "./resources/js/components/FooterComponent.vue")["default"]); // Vue.component('contactform-component', require('./components/ContactFormComponent.vue').default);
...
var footer = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  el: '#footer'
