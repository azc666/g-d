...
{{-- <div class="flex p-8 pb-64 sm:pb-2 sm:mt-0 mx-auto container background-trans border rounded-lg shadow-lg"> --}}
  ...
  <div class="flex container m-0">
    ...
    <div class="w-1 sm:w-1/4">
      <img class="w-0 sm:w-full mr-12" src="/assets/posters/sendfiles.jpg" alt="">
    </div>

    <div class="w-full sm:w-3/4">
      {{-- <h1 class="text-4xl md:text-5xl text-gray-800 -mt-6 sm:pl-12 text-center sm:text-left font-chicle">
        Sending Files
      </h1> --}}
      <h1 class="text-4xl md:text-5xl text-gray-800 -mt-6 sm:pl-12 text-center sm:text-left font-chicle">
      Sending Files
      ...
      <h3 class="text-2xl text-gray-800 sm:ml-12 sm:-mt-4 text-left font-chicle">
        Web Browser
      </h3>
      {{-- <p class="text-base md:text-xl text-gray-700 sm:ml-12 mb-2 sm:mb-8 sm:mr-6 font-myriad">
      ...
      {{-- <p class="text-base md:text-xl text-gray-700 sm:ml-12 mb-32 sm:mb-56 sm:mr-6 font-myriad"> --}}
